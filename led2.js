...
app.get('/:channel/:intensity', function(req, res) {
  ...
  if (channel == 0) {
    switch (intensity) {
      case '0':
        pwm.setDutyCycle(0, 0.10);
        res.send('Channel' + ' ' + channel + ' ' + 'Led intensity set to' + ' ' + intensity);
        break
      case '15':
        pwm.setDutyCycle(0, 0.15);
        res.send('Channel' + ' ' + channel + ' ' + 'Led intensity set to' + ' ' + intensity);
        break
      case '20':
        pwm.setDutyCycle(0, 0.2);
        res.send('Channel' + ' ' + channel + ' ' + 'Led intensity set to' + ' ' + intensity);
        break
      case '30':
        pwm.setDutyCycle(0, 0.3);
        res.send('Channel' + ' ' + channel + ' ' + 'Led intensity set to' + ' ' + intensity);
        break
      case '40':
        pwm.setDutyCycle(0, 0.4);
        res.send('Channel' + ' ' + channel + ' ' + 'Led intensity set to' + ' ' + intensity);
        break
      case '50':
        pwm.setDutyCycle(0, 0.5);
        res.send('Channel' + ' ' + channel + ' ' + 'Led intensity set to' + ' ' + intensity);
        break
      case '60':
        pwm.setDutyCycle(0, 0.6);
        res.send('Channel' + ' ' + channel + ' ' + 'Led intensity set to' + ' ' + intensity);
        break
      case '70':
        pwm.setDutyCycle(0, 0.7);
        res.send('Channel' + ' ' + channel + ' ' + 'Led intensity set to' + ' ' + intensity);
        break
      case '80':
        pwm.setDutyCycle(0, 0.8);
        res.send('Channel' + ' ' + channel + ' ' + 'Led intensity set to' + ' ' + intensity);
        break
      case '90':
        pwm.setDutyCycle(0, 0.9);
        res.send('Channel' + ' ' + channel + ' ' + 'Led intensity set to' + ' ' + intensity);
        break
      case '100':
